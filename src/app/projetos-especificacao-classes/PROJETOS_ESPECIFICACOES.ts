...
export const PROJETOS_ESPECIFICACOES: ProjetoEspecificacao[] = [
    {
        ...
        imagemDaTecnologia: "../../assets/images/android-logo.png",//logo android
        imagens:[
            {imageURL:"../../assets/images/projeto-aluguel/main_activity.png",altTexto:"Tela principal",tituloCarousel:"Tela principal",descricaoCarousel:"A tela inicial do sistema mobile."},
            {imageURL:"../../assets/images/projeto-aluguel/estoque_activity.png",altTexto:"Tela de listagem de itens cadastrados",tituloCarousel:"Tela de listagem de itens"},
            {imageURL:"../../assets/images/projeto-aluguel/estoque_activity_com_popupMenu.png",altTexto:"PopUp menu da tela de listagem",tituloCarousel:"PopUp menu da tela de listagem"},
            {imageURL:"../../assets/images/projeto-aluguel/item_activity.png",altTexto:"Tela de cadastro/modificação de itens",tituloCarousel:"Tela de cadastro/modificação de itens"},
            {imageURL:"../../assets/images/projeto-aluguel/calendarioCustomizado.png",altTexto:"Calendário customizado",tituloCarousel:"Calendário customizado",descricaoCarousel: "Utilizado para o cadastro de aluguel e listagem"},
            {imageURL:"../../assets/images/projeto-aluguel/calendarioCustomizado2.png",altTexto:"Calendário customizado",tituloCarousel:"Calendário customizado",descricaoCarousel: "Selecionando uma data para cadastrar um aluguel"},
            {imageURL:"../../assets/images/projeto-aluguel/cadastroAluguel.png",altTexto:"Tela de cadastro/modificação de aluguel",tituloCarousel:"Tela de cadastro/modificação de aluguel"},
            {imageURL:"../../assets/images/projeto-aluguel/ListagemAluguel.png",altTexto:"Tela de listagem de alugueis",tituloCarousel:"Tela de listagem de alugueis"},
            {imageURL:"../../assets/images/projeto-aluguel/ListagemAluguel2.png",altTexto:"Tela de listagem de alugueis",tituloCarousel:"Tela de listagem de alugueis"},
    ...
    },
    {
        ...
        imagemDaTecnologia: "../../assets/images/spring-boot-logo.jpg",//logo android
        imagens:[
            {imageURL:"../../assets/images/projeto-sgq/TelaInicial.PNG",altTexto:"Tela principal"},
            {imageURL:"../../assets/images/projeto-sgq/TelaInicial2.PNG",altTexto:"Tela principal"},
            {imageURL:"../../assets/images/projeto-sgq/TelaInicial3.PNG",altTexto:"Tela principal"},
            {imageURL:"../../assets/images/projeto-sgq/TelaInicial4.PNG",altTexto:"Tela principal"},
            {imageURL:"../../assets/images/projeto-sgq/CadastrarQuestao.PNG",altTexto:"Tela de cadastrar questão"},
            {imageURL:"../../assets/images/projeto-sgq/CadastrarQuestao2.PNG",altTexto:"Tela de cadastrar questão"},
            {imageURL:"../../assets/images/projeto-sgq/CadastrarQuestao3.PNG",altTexto:"Tela de cadastrar questão"},
            {imageURL:"../../assets/images/projeto-sgq/CadastrarQuestao4.PNG",altTexto:"Tela de cadastrar questão"},
            {imageURL:"../../assets/images/projeto-sgq/consultarQuestao.PNG",altTexto:"Tela de consultar questão"},
            {imageURL:"../../assets/images/projeto-sgq/consultarQuestao2.PNG",altTexto:"Tela de consultar questão"},
            {imageURL:"../../assets/images/projeto-sgq/consultarQuestao3.PNG",altTexto:"Tela de consultar questão"},
            {imageURL:"../../assets/images/projeto-sgq/consultarQuestao4.PNG",altTexto:"Tela de consultar questão"},
            {imageURL:"../../assets/images/projeto-sgq/cadastrarProfessor.PNG",altTexto:"Tela de cadastrar professor"},
            {imageURL:"../../assets/images/projeto-sgq/cadastrarDisciplina.PNG",altTexto:"Tela de cadastrar disciplina"},
            {imageURL:"../../assets/images/projeto-sgq/cadastrarProva.PNG",altTexto:"Tela de cadastrar prova"},
            {imageURL:"../../assets/images/projeto-sgq/cadastrarProva2.PNG",altTexto:"Tela de cadastrar prova"},
            {imageURL:"../../assets/images/projeto-sgq/consultarProva.PNG",altTexto:"Tela de consultar provas"}
        ],
        tecnologiasAuxiliares:[
            {
                idTecnologiaAuxiliar:1,
                imagemLocation: "../../assets/images/tecnologias-auxiliares/bootstrap-logo.svg"
            },
            {
                idTecnologiaAuxiliar:2,
                imagemLocation: "../../assets/images/tecnologias-auxiliares/logoJquery.gif"
            },
            {
                idTecnologiaAuxiliar:3,
                imagemLocation: "../../assets/images/tecnologias-auxiliares/postgresqlLogo.png"
            },
            {
                idTecnologiaAuxiliar:4,
                imagemLocation: "../../assets/images/tecnologias-auxiliares/tinymceLogo.png"
            },
            {
                idTecnologiaAuxiliar:5,
                imagemLocation: "../../assets/images/tecnologias-auxiliares/thymeleafLogo.png"
            }
        ],
        accordionCards: [
            {
